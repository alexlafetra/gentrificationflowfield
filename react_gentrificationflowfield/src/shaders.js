...
//Identity function so I can tag string literals with the  marker
const glsl = x => {return x};
...
export const fadeToTransparentVert = `
...
`;
export const fadeToTransparentFrag = `
precision highp float;
precision highp sampler2D;
...
export const updateParticleAgeVert = `
precision highp float;
precision highp sampler2D;
...
export const updateParticleAgeFrag = `
precision highp float;
precision highp sampler2D;
...
export const updateParticleDataVert = `
precision highp float;
precision highp sampler2D;
...
export const updateParticleDataFrag = `
precision highp float;
precision highp sampler2D;
...
export function createFlowFieldShader(nAttractors,nRepulsors){
    return{
        ...
        uniform vec3 uAttractors[`+nAttractors+`];//array holding all the attractors as [x,y,strength]
        uniform vec3 uRepulsors[`+nRepulsors+`];//array holding all the repulsors as [x,y,strength]
